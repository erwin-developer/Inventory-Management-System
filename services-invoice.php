       ...
       <div class="container main">
         <div class="row">
           <div class="main-col">
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3">
                   ...
                   <table class="table borderless" style="margin-top:30px;">
                     <thead style="border-bottom:1px solid #ddd;">
                      ...
                      <?php
                      echo "<tbody>";
                      $query = "SELECT * FROM services WHERE `transaction` = '$get_id' ";
             ...
             <p class="text-center">
             <a href="services-print.php?id=<?php echo $ntrasaction;?>" target="print"><i class="fa fa-print" aria-hidden="true"></i> Print</a></p>
             </div><!--main-col-->
           </div><!--/row-->
         </div><!--/container-->
       </form>
