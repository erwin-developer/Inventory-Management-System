             ...
             <div class="col-md-12">
                   <div class="panel panel-default" style="width:600px;margin:0 auto;">
                       <div class="panel-heading">
                        <strong>REFORMAT REVENUE</strong>
                       </div>
                   ...
                   <div class="tab-pane active" id="daily">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(cost) as grandtotal FROM services GROUP BY date(date) ORDER BY date DESC";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
                   ...
                   <div id="weekly" class="tab-pane">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(cost) as grandtotal FROM services GROUP BY week(date) ORDER BY date DESC";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
                   ...
                   <div id="monthly" class="tab-pane">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(cost) as grandtotal FROM services GROUP BY month(date) ORDER BY date DESC";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
                   ...
                   <div id="all" class="tab-pane">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(cost) as grandtotal FROM services";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
