                   ...
                   <div class="tab-pane active" id="daily">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(grand_total) as grandtotal FROM order_item GROUP BY date(date) ORDER BY date DESC";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
                   ...
                   <div id="weekly" class="tab-pane">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(grand_total) as grandtotal FROM order_item GROUP BY week(date) ORDER BY date DESC";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
                   ...
                   <div id="monthly" class="tab-pane">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(grand_total) as grandtotal FROM order_item GROUP BY month(date) ORDER BY date DESC";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
                   ...
                   <div id="all" class="tab-pane">
                     <table data-toggle="table" id="mytable" style="margin-top:15px;" class="order-table table table-bordred table-striped">
                       <thead>
                        ...
                        <?php
                        echo "<tbody>";
                        $query = "SELECT *, SUM(grand_total) as grandtotal FROM order_item";
                          $results = $database->get_results( $query );
                              foreach( $results as $row ){
                                echo "<tr>
                                      <td>".$row['date']."</td>
