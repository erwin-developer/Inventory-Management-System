...
if(!isset($_SESSION['id'])){
    ...
    if(!isset($_SESSION['joborder'])){
         header("Location: creating-joborder.php");
            exit();
        }
      ...
      $employee = $row['fullname'];
        ...
        if (isset($_POST['formsubmitted'])) {
          $error = array();
            ...
            if (empty($_POST['hd_serial'])) {
              $error[] = '<span class="text-danger">Please enter HD Serial number!</span>';
              } else {
              $hd_serial = $database->filter($_POST['hd_serial']);
              }
            ...
            if (empty($error)) {
              ...
              $data = array(
                  ...
                  $add_query = $database->insert( 'services', $data );
                  if( $add_query ){

                    header("Location: services-invoice.php?id=$joborder");
         ...
         <div class="row">
           <div class="main-col">
             <div class="panel panel-default" style="width:700px;margin:0 auto;">
                 <div class="panel-heading"><strong>REFORMAT SERVICE</strong>
                </div>
                   ...
                   if (!isset($showMsg)) $showMsg = '';
                     ...
                     <div class="row" style="padding:10px 25px 25px 25px;">
                       <div class="col-xs-6 col-sm-6 col-md-6">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6">
                          <div class="form-group">
                           <label class="control-label">HD SERIAL #</label>
                           <input type="text" name="hd_serial" value="<?php if(isset($_POST['hd_serial'])) echo $_POST['hd_serial'];?>" class="form-control">
                           </div>
                          </div>
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                             <div class="form-group">
                              ...
                              <option value="basic"<?php if(isset($_POST['service']) && $_POST['service'] == "basic") echo 'selected';?>>Basic</option>
                              <option value="extra"<?php if(isset($_POST['service']) && $_POST['service'] == "extra") echo 'selected';?>>Extra</option>
                              </select>
                            </div>
                          </div>
